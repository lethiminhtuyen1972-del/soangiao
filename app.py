...
<div class="main-header">
    ...
    <p>Tác giả: Lê Thị Minh Tuyến- Trường Tiểu học Hùng An - ĐT: 08577159546</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lê Thị Minh Tuyến - Trường tiểu học Hùng An - ĐT: 0857159546</div>", unsafe_allow_html=True)
